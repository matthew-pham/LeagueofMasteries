 ...
 $data1 = '{
   ...
   "data": {
      ...
      "3087": {
         ...
         "description": "<stats>+35% Attack Speed<br>+30% Critical Strike Chance<br>+5% Movement Speed</stats><br><br><passive>Passive:</passive> Moving and attacking will make an attack Energized.<br><br><unique>UNIQUE Passive - Shiv Lightning:</unique> Your Energized attacks deal 50~120 bonus magic damage (based on level) to up to 5 targets on hit (deals +120% bonus damage to minions and can critically strike).",
         "name": "Statikk Shiv"
      },
      "3086": {
         "id": 3086,
      ...
      "1419": {
         ...
         "description": "<stats>+40% Attack Speed</stats><br><br><unique>UNIQUE Passive:</unique> Basic attacks deal 3% of the target\'s maximum Health in bonus physical damage (max 75 vs. monsters and minions) on hit.",
      ...
      "3094": {
         ...
         "description": "<stats>+30% Attack Speed<br>+30% Critical Strike Chance<br>+5% Movement Speed</stats><br><br><passive>Passive:</passive> Moving and attacking will make an attack Energized.<br><br><unique>UNIQUE Passive - Firecannon:</unique> Your Energized attacks gain 35% bonus Range (+150 range maximum) and deal 50~160 bonus magic damage (based on level) on hit.<br><br>Energized attacks function on structures.",
      ...
      "2015": {
         ...
         "description": "<stats>+15% Attack Speed</stats><br><br><passive>Passive:</passive> Moving and attacking will make an attack Energized.<br><br><unique>UNIQUE Passive - Energized Strike:</unique> Your Energized attacks deal 40 bonus magic damage on hit.",
         "name": "Kircheis Shard",
         "into": [
            "3087",
            "3094"
      ...
      "3800": {
         ...
         "description": "<stats>+500 Health<br><mana>+300 Mana</mana><br>+100% Base Health Regen </stats><br><br><unique>UNIQUE Passive - Eternity:</unique> 15% of damage taken from champions is gained as Mana. Spending Mana restores 25% of the cost as Health, up to 25 per spell cast.  <br><unique>UNIQUE Active:</unique> Grants +75% Movement Speed when moving towards enemies or enemy turrets for 4 seconds. After 3 seconds, a shockwave is emitted, slowing nearby enemy champion Movement Speed by 75% for 2 second(s) (90 second cooldown).<br><br>This effect may be reactivated early to instantly release the shockwave.",
      ...
      "3152": {
         ...
         "description": "<stats>+300 Health<br>+60 Ability Power<br>+10% Cooldown Reduction</stats><br><br><unique>UNIQUE Active - Fire Bolt:</unique> Dash forward and unleash a nova of fire bolts that deal <levelScale>75 - 150</levelScale> (+35% of your Ability Power) as magic damage (40 second cooldown, shared with other <font color=\'#9999FF\'>Hextech</font> items).<br><br>Champions and Monsters hit by multiple fire bolts take 20% damage per additional bolt.<br><br><rules>(This dash cannot pass through terrain.)</rules>",
      ...
      "3151": {
         ...
         "description": "<stats>+80 Ability Power<br>+300 Health</stats><br><br><unique>UNIQUE Passive - Eyes of Pain:</unique> +15 Magic Penetration<br><unique>UNIQUE Passive:</unique> Spells burn enemies for 3 seconds, dealing bonus magic damage equal to 2% of their current Health per second. Burn damage is doubled against movement-impaired units.",
      ...
      "3135": {
         ...
         "description": "<stats>+80 Ability Power</stats><br><br><unique>UNIQUE Passive:</unique> +35% Magic Penetration.",
         "name": "Void Staff"
      },
      "3136": {
         "id": 3136,
         "plaintext": "Increases magic damage",
         "description": "<stats>+25 Ability Power<br>+200 Health</stats><br><br><unique>UNIQUE Passive - Eyes of Pain:</unique> +15 Magic Penetration",
         "name": "Haunting Guise",
         "into": ["3151"]
      },
      "3137": {
      ...
      "3142": {
         ...
         "description": "<stats>+65 Attack Damage<br>+10% Cooldown Reduction</stats><br><br><unique>UNIQUE Passive:</unique> +20 Armor Penetration<br><active>UNIQUE Active:</active> Grants +20% Movement Speed and +40% Attack Speed for 6 seconds (45 second cooldown).",
         "name": "Youmuu\'s Ghostblade"
      },
      "3145": {
         "id": 3145,
         "plaintext": "Increases Ability Power. Deal bonus magic damage on attack periodically.",
         "description": "<stats>+40 Ability Power</stats><br><br><unique>UNIQUE Passive - Magic Bolt:</unique> Damaging an enemy champion with a basic attack shocks them for <levelScale>75 - 150</levelScale> bonus magic damage (40 second cooldown, shared with other <font color=\'#9999FF\'>Hextech</font> items).<br><br><rules>(Damage scales based on level.  Hextech effects can trigger other item spell effects.)</rules>",
      ...
      "3029": {
         ...
         "description": "<stats>+300 Health<br><mana>+300 Mana</mana><br>+60 Ability Power</stats><br><br><passive>Passive:</passive> Grants +20 Health, +10 Mana, and +4 Ability Power per stack (max +200 Health, +100 Mana, and +40 Ability Power). Grants 1 stack per 40 seconds (max 10 stacks).<br><unique>UNIQUE Passive - Eternity:</unique> 15% of damage taken from champions is gained as Mana. Spending Mana restores 25% of the cost as Health, up to 25 per spell cast.",
         "name": "Rod of Ages (Crystal Scar)"
      },
      "3027": {
         "id": 3027,
         "plaintext": "Greatly increases Health, Mana, and Ability Power",
         "description": "<stats>+300 Health<br><mana>+300 Mana</mana><br>+60 Ability Power</stats><br><br><passive>Passive:</passive> Grants +20 Health, +10 Mana, and +4 Ability Power per stack (max +200 Health, +100 Mana, and +40 Ability Power). Grants 1 stack per minute (max 10 stacks).<br><unique>UNIQUE Passive - Eternity:</unique> 15% of damage taken from champions is gained as Mana. Spending Mana restores 25% of the cost as Health, up to 25 per spell cast.  ",
         "name": "Rod of Ages"
      },
      "3028": {
         "id": 3028,
      ...
      "3512": {
         ...
         "description": "<stats>+55 Armor<br>+55 Magic Resist<br>+125% Base Health Regen <br></stats><br><unique>UNIQUE Passive - Point Runner:</unique> Builds up to +20% Movement Speed over 2 seconds while near turrets, fallen turrets and Void Gates.<br><active>UNIQUE Active:</active> Spawns a Void Gate for 150 seconds (150 second cooldown).<br><br>Every 4 seconds the gate makes a Voidspawn. The first and every fourth Voidspawn gains 15% of maximum Health as damage.",
         "name": "Zz\'Rot Portal"
      },
      "3035": {
         "id": 3035,
         "plaintext": "Overcomes enemies with high Armor",
         "description": "<stats>+25 Attack Damage</stats><br><br><unique>UNIQUE Passive - Last Whisper:</unique> +30% Bonus Armor Penetration",
         "name": "Last Whisper",
         "into": [
            "3033",
            "3036"
      ...
      "3033": {
         ...
         "description": "<stats>+40 Attack Damage</stats><br><br><unique>UNIQUE Passive - Executioner:</unique> Physical damage inflicts Grievous Wounds on enemy champions for 5 seconds.<br><unique>UNIQUE Passive - Last Whisper:</unique> +45% Bonus Armor Penetration.",
      ...
      "3030": {
         ...
         "description": "<stats>+300 Health<br><mana>+400 Mana</mana><br>+80 Ability Power</stats><br><br><unique>UNIQUE Passive - Eternity:</unique> 15% of damage taken from champions is gained as Mana. Spending Mana restores 25% of the cost as Health, up to 25 per spell cast.<br><unique>UNIQUE Active - Frost Bolt:</unique> Fires a spray of icy bolts that explode, dealing <levelScale>100 - 200</levelScale> (+35% of your Ability Power) magic damage to all enemies hit. (40 second cooldown, shared with other <font color=\'#9999FF\'>Hextech</font> items).<br><br>Enemies hit are slowed by 65% decaying over 0.5 seconds.<br><br><rules>(Frost Bolt has a cast time, in contrast to most actives.)</rules> ",
         "name": "Hextech GLP-800"
      },
      "3222": {
         "id": 3222,
         "plaintext": "Activate to heal and remove all disabling effects from an allied champion",
         "description": "<stats>+35 Magic Resist<br>+10% Cooldown Reduction<br><mana>+150% Base Mana Regen </mana></stats><br><br><unique>UNIQUE Passive:</unique> Increases Base Health Regeneration by 100% if current Health % is lower than current Mana %. <mana>Increases Base Mana Regeneration by 100% if current Mana % is lower than current Health %.</mana><br><active>UNIQUE Active:</active> Removes all stuns, roots, taunts, fears, silences, and slows on an allied champion and heals that champion for 150 (+10% of maximum Health) (180 second cooldown).",
         "name": "Mikael\'s Crucible"
      },
      "3134": {
         "id": 3134,
         "plaintext": "Increases Attack Damage and Armor Penetration",
         "description": "<stats>+20 Attack Damage</stats><br><br><unique>UNIQUE Passive:</unique> +10 Armor Penetration<br><unique>UNIQUE Passive:</unique> After killing any unit, your next basic attack or single target spell deals +15 damage.",
         "name": "Serrated Dirk",
         "into": [
            "3142",
            "3147",
      ...
      "3020": {
         ...
         "description": "<stats>+15 Magic Penetration</stats><br><br><unique>UNIQUE Passive - Enhanced Movement:</unique> +45 Movement Speed<br><br><rules>(Magic Penetration: Magic damage is increased by ignoring an amount of the target\'s Magic Resist equal to Magic Penetration.)</rules>",
      ...
      "3123": {
         ...
         "description": "<stats>+15 Attack Damage</stats><br><br><unique>UNIQUE Passive - Executioner:</unique> Physical damage inflicts Grievous Wounds on enemy champions for 3 seconds.",
      ...
      "3053": {
         ...
         "description": "<stats>+400 Health<br>+25% Base Attack Damage </stats><br><br><unique>UNIQUE Passive - Lifeline:</unique> Upon taking at least 400 to 1800 damage (based on level) within 5 seconds, gain a rapidly decaying Shield for 30% of your maximum Health for 8 seconds (45 second cooldown).<br><br><unlockedPassive>Sterak\'s Fury:</unlockedPassive> When <i>Lifeline</i> triggers, grow in size and strength, gaining +25% additional Base Attack Damage.",
         "name": "Sterak\'s Gage"
      },
      "3050": {
         "id": 3050,
      ...
      "3036": {
         ...
         "description": "<stats>+40 Attack Damage</stats><br><br><unique>UNIQUE Passive - Giant Slayer:</unique> Grants up to +15% physical damage against enemy champions with greater maximum Health than you (+1.5% damage per 50 Health difference, maxing at 500 Health difference).<br><unique>UNIQUE Passive - Last Whisper:</unique> +45% Bonus Armor Penetration",
      ...
      "1039": {
         ...
         "description": "<stats><mana>+150% Base Mana Regen while in Jungle  </mana></stats><br><br><unique>UNIQUE Passive - Tooth:</unique> Damaging a monster with a spell or attack  steals 25 Health over 5 seconds. Killing monsters grants <font color=\'#99BBBB\'>special bonus experience</font>.",
      ...
      "1041": {
         ...
         "description": "<stats>+8% Life Steal vs. Monsters</stats><br><br><unique>UNIQUE Passive - Nail:</unique> Basic attacks deal 20 bonus damage on hit vs. Monsters. Killing monsters grants <font color=\'#99BBBB\'>special bonus experience</font>.",
      ...
      "3174": {
         ...
         "description": "<stats>+40 Ability Power<br>+25 Magic Resist<br>+20% Cooldown Reduction<br><mana>+75% Base Mana Regen </mana></stats><br><br><unique>UNIQUE Passive:</unique> Gain 20% of the <font color=\'#6666FF\'><u>premitigation</u></font> damage dealt to champions as Blood Charges, up to <levelScale>100 - 250</levelScale>  max. Healing or shielding another ally consumes charges to heal them, up to the original effect amount.<br><unique>UNIQUE Passive:</unique> Increases Base Health Regeneration by 100% if current Health % is lower than current Mana %. <mana>Increases Base Mana Regeneration by 100% if current Mana % is lower than current Health %.</mana><br><br><rules>(Maximum amount of Blood Charges stored is based on level. Healing amplification is applied to the total heal value.)</rules>",
      ...
      "3165": {
         ...
         "description": "<stats>+100 Ability Power<br><mana>+400 Mana</mana></stats><br><br><unique>UNIQUE Passive:</unique> +20% Cooldown Reduction<br><unique>UNIQUE Passive:</unique> Dealing magic damage to champions below 35% Health inflicts Grievous Wounds for 8 seconds.<br><unique>UNIQUE Passive:</unique> Kills and Assists restore 20% of your maximum Mana.",
         "name": "Morellonomicon"
      },
      "3065": {
         "id": 3065,
...
function getAllItemData() { 
    ...
    return json_decode($GLOBALS['data1'], true)['data'];   
}
